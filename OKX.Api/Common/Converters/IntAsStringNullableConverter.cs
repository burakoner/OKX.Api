...
/// <summary>
/// Converts nullable <see cref="int"/> values to and from their string representations when serializing and
/// deserializing JSON.
/// </summary>
public class IntAsStringNullableConverter : JsonConverter<int?>
{
    /// <inheritdoc/>
