...
#pragma warning disable CS0612 // Type or member is obsolete
        ...
        [
            ...
            .AddEndpointLimit("/api/v5/affiliate/performance/summary", 3, TimeSpan.FromSeconds(1), HttpMethod.Get, true)
            .AddEndpointLimit("/api/v5/affiliate/invitee/detail", 3, TimeSpan.FromSeconds(1), HttpMethod.Get, true)
            .AddEndpointLimit("/api/v5/affiliate/invitee/list", 3, TimeSpan.FromSeconds(1), HttpMethod.Get, true)
            .AddEndpointLimit("/api/v5/affiliate/link/list", 3, TimeSpan.FromSeconds(1), HttpMethod.Get, true)
            .AddEndpointLimit("/api/v5/affiliate/co-inviter/list", 3, TimeSpan.FromSeconds(1), HttpMethod.Get, true)
            .AddEndpointLimit("/api/v5/affiliate/sub-affiliate/list", 3, TimeSpan.FromSeconds(1), HttpMethod.Get, true)
