...
public class OKXWebSocketApiOrderBookTradingClient
{
    ...
    /// Market Data Client
    /// </summary>
    public OKXWebSocketApiMarketDataClient MarketData { get; }

    // Root Client
    internal OKXWebSocketApiClient RootClient { get; }

    public OKXWebSocketApiOrderBookTradingClient(OKXWebSocketApiClient root)
    {
        ...
        MarketData = new  OKXWebSocketApiMarketDataClient(root);
    }
