...
public class OKXRestApiPublicDataClient : OKXRestApiBaseClient
{
    ...
    internal OKXRestApiPublicDataClient(OKXRestApiClient root) : base(root)
    {
    }
    ...
    /// <param name="ct">Cancellation Token</param>
    /// <returns></returns>
    public async Task<RestCallResult<Models.PublicData.OkxInterestRate>> GetInterestRatesAsync(CancellationToken ct = default)
    {
